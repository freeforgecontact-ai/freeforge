      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }} className="no-print">
        <div>
          ...
          <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: 'white', display: 'flex', alignItems: 'center', gap: 10 }}>
            ✨ Flashcard Active Quizzer
          </h1>
          <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', marginTop: 4 }}>
            Cartes mémoires avec système SRS local.
          </p>
        </div>
        <FolderButton toolId="flashcard_quizzer" toolName="FlashcardsQuizzer" localStorageKeys={["fs_flashcards"]} />
      </div>
