...
import RecettesPortions from './tools/RecettesPortions';
import PantryStock from './tools/PantryStock';
import HydratationLog from './tools/HydratationLog';
import IMCMetabolisme from './tools/IMCMetabolisme';
import CyclesSommeil from './tools/CyclesSommeil';
import MealPrepMenu from './tools/MealPrepMenu';
import NutrimentsMacros from './tools/NutrimentsMacros';
import MeditationSons from './tools/MeditationSons';
  ...
  const toolsList = [
    {
      ...
      desc: "Adaptez les doses selon le nombre de portions.",
      category: 'main',
      icon: (
      ...
      component: <RecettesPortions goBack={() => setActiveTool(null)} />
    },
    {
      id: 'pantry_tracker',
      title: "Pantry & Expiration Tracker",
      desc: "Registre de vos denrées périssables.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <PantryStock goBack={() => setActiveTool(null)} />
    },
    {
      id: 'water_intake',
      title: "Water Intake Log",
      desc: "Journal de suivi d'hydratation quotidienne.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <HydratationLog goBack={() => setActiveTool(null)} />
    },
    {
      id: 'imc_health',
      title: "Calculateur IMC & Métabolisme",
      desc: "Déterminez IMC, BMR et besoins caloriques.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <IMCMetabolisme goBack={() => setActiveTool(null)} />
    },
    {
      id: 'sleep_cycle',
      title: "Sleep Cycle Calculator",
      desc: "Trouvez vos heures d'endormissement optimales.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <CyclesSommeil goBack={() => setActiveTool(null)} />
    },
    {
      id: 'meal_prep',
      title: "Meal Prep Menu Planner",
      desc: "Planifiez vos repas de la semaine.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <MealPrepMenu goBack={() => setActiveTool(null)} />
    },
    {
      id: 'nutrient_calculator',
      title: "Calculateur de Nutriments",
      desc: "Équilibre nutritionnel journalier.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <NutrimentsMacros goBack={() => setActiveTool(null)} />
    },
    {
      id: 'meditation_soundscape',
      title: "Meditation Soundscape Mixer",
      desc: "Mixeur d'ambiance relaxante pour le Yoga.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <MeditationSons goBack={() => setActiveTool(null)} />
    }
  ];
      ...
      <aside className="forge-sidebar no-print">
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <a href="#" className="forge-logo-wrapper" onClick={(e) => { e.preventDefault(); setActiveTool(null); }}>
            <div className="forge-logo-icon" style={{ background: 'linear-gradient(135deg, #84cc16, #22c55e)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span className="forge-logo-text">Forge Cuisine & Santé</span>
      ...
      <main className="forge-workspace">
        ...
        {activeTool === null ? (
          ...
          <section style={{ position: 'relative', zIndex: 10 }}>
            <h1 className="page-title">Forge Cuisine & Santé</h1>
            <p className="page-subtitle">Découvrez notre gamme d'outils premium 100% locaux dédiés à la catégorie Santé. Fonctionne sans envoi de données.</p>
