...
import CoteRGPA from './tools/CoteRGPA';
import FlashcardsQuizzer from './tools/FlashcardsQuizzer';
import PomodoroStudy from './tools/PomodoroStudy';
import CitationsGenerateur from './tools/CitationsGenerateur';
import PDFOrganisateur from './tools/PDFOrganisateur';
import MindMapsVectoriel from './tools/MindMapsVectoriel';
import AnalyseurLisibilite from './tools/AnalyseurLisibilite';
import HorairesEtudes from './tools/HorairesEtudes';
...
export default function App() {
  ...
  const toolsList = [
    {
      id: 'gpa_coter',
      title: "Calculateur Cote R & GPA",
      desc: "Suivi des notes collégiales et universitaires.",
      category: 'main',
      icon: (
      ...
      component: <CoteRGPA goBack={() => setActiveTool(null)} />
    },
    {
      id: 'flashcard_quizzer',
      title: "Flashcard Active Quizzer",
      desc: "Cartes mémoires avec système SRS local.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <FlashcardsQuizzer goBack={() => setActiveTool(null)} />
    },
    {
      id: 'pomodoro_study',
      title: "Pomodoro Focus Engine",
      desc: "Chronomètre de travail et bruit ambiant.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <PomodoroStudy goBack={() => setActiveTool(null)} />
    },
    {
      id: 'citations_generator',
      title: "Générateur de Citations",
      desc: "Créez vos citations APA, MLA, Harvard.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <CitationsGenerateur goBack={() => setActiveTool(null)} />
    },
    {
      id: 'pdf_splitter',
      title: "PDF Organizer & Splitter",
      desc: "Découpez et fusionnez vos PDF localement.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <PDFOrganisateur goBack={() => setActiveTool(null)} />
    },
    {
      id: 'mind_map',
      title: "Mind Map Vector Drawer",
      desc: "Cartes mentales SVG interactives.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <MindMapsVectoriel goBack={() => setActiveTool(null)} />
    },
    {
      id: 'readability_analyzer',
      title: "Analyseur de Texte & Lisibilité",
      desc: "Indices de lisibilité Flesch-Kincaid.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <AnalyseurLisibilite goBack={() => setActiveTool(null)} />
    },
    {
      id: 'class_schedule',
      title: "Class & Schedule Planner",
      desc: "Emploi du temps interactif de session.",
      category: 'main',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" style={{width:24, height:24}}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
      ...
      component: <HorairesEtudes goBack={() => setActiveTool(null)} />
    }
  ];
      ...
      <aside className="forge-sidebar no-print">
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <a href="#" className="forge-logo-wrapper" onClick={(e) => { e.preventDefault(); setActiveTool(null); }}>
            <div className="forge-logo-icon" style={{ background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span className="forge-logo-text">Forge Étudiant</span>
      ...
      <main className="forge-workspace">
        ...
        {activeTool === null ? (
          ...
          <section style={{ position: 'relative', zIndex: 10 }}>
            <h1 className="page-title">Forge Étudiant</h1>
            <p className="page-subtitle">Découvrez notre gamme d'outils premium 100% locaux dédiés à la catégorie Éducation. Fonctionne sans envoi de données.</p>
